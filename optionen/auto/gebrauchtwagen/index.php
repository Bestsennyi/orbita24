...
orbita24_set_current_page('/optionen/auto/gebrauchtwagen/');
?>
<!doctype html>
<html lang="de">
  <head>
      ...
      <section class="section structure-section">
        <div class="container structure-container">
          ...
          <div class="structure-header offer-intro">
            <h1>Gebrauchtwagen im &Uuml;berblick</h1>
            <p>Passende Fahrzeuge einfach vergleichen.</p>
          </div>
          ...
          <div class="offer-grid" aria-label="Demo Angebote">
            <article class="card offer-card">
              ...
              <h2>Basis Option</h2>
              <p>Einstieg<br />Schnelle Auswahl</p>
              <ul>
              ...
              <p>Mehr Auswahl<br />Individuell pr&uuml;fen</p>
              <ul>
                <li>Mehr Optionen</li>
                <li>Flexible Auswahl</li>
              ...
              <p>Direkt Fahrzeug finden<br />Schnell starten</p>
              <ul>
                <li>Schnell verf&uuml;gbar</li>
                <li>Einfach finden</li>
