...
orbita24_set_current_page('/optionen/auto/leasing/');
?>
<!doctype html>
<html lang="de">
  <head>
    ...
    <main>
      <section class="section structure-section">
        <div class="container structure-container">
            ...
            <a href="/optionen/auto/" class="structure-back" aria-label="Zur&uuml;ck zu Auto">
          ...
          <div class="structure-header offer-intro">
            <h1>Leasing im &Uuml;berblick</h1>
            <p>Flexible Leasingangebote f&uuml;r Ihr Fahrzeug nutzen.</p>
          </div>
          ...
          <div class="offer-grid" aria-label="Demo Angebote">
            <article class="card offer-card">
              ...
              <h2>Basis Option</h2>
              <p>Einfaches Leasingmodell<br />Schnell starten</p>
              <ul>
              ...
              <p>Individuelles Leasing<br />Anpassbar und flexibel</p>
              <ul>
              ...
              <p>Direkt Leasing starten<br />Online verf&uuml;gbar</p>
              <ul>
                <li>Schnell verf&uuml;gbar</li>
                <li>Einfach abschlie&szlig;en</li>
                <li>Direkt nutzen</li>
              </ul>
              <a href="/kontakt.php" class="btn offer-cta" data-offer="true">Zum Angebot</a>
            </article>          </div>
