...
orbita24_set_current_page('/optionen/auto/autokredit/');
?>
<!doctype html>
<html lang="de">
  <head>
      ...
      <section class="section structure-section">
        <div class="container structure-container">
          ...
          <div class="structure-header offer-intro">
            <h1>Autokredit im &Uuml;berblick</h1>
            <p>Passende Finanzierung f&uuml;r Ihr Fahrzeug finden.</p>
          </div>
          ...
          <div class="offer-grid" aria-label="Demo Angebote">
            <article class="card offer-card">
              ...
              <h2>Basis Option</h2>
              <p>Einfacher Autokredit<br />Schnell verst&auml;ndlich</p>
              <ul>
              ...
              <p>Individuelle Finanzierung<br />Passend zur Situation</p>
              <ul>
              ...
              <p>Direkt Kredit starten<br />Online verf&uuml;gbar</p>
              <ul>
                <li>Schnell verf&uuml;gbar</li>
                <li>Einfach beantragen</li>
