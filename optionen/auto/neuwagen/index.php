...
orbita24_set_current_page('/optionen/auto/neuwagen/');
?>
<!doctype html>
<html lang="de">
  <head>
      ...
      <section class="section structure-section">
        <div class="container structure-container">
          ...
          <div class="structure-header offer-intro">
            <h1>Neuwagen im &Uuml;berblick</h1>
            <p>Aktuelle Modelle einfach vergleichen.</p>
          </div>
          ...
          <div class="offer-grid" aria-label="Demo Angebote">
            <article class="card offer-card">
              ...
              <h2>Basis Option</h2>
              <p>Einstieg<br />Modelle entdecken</p>
              <ul>
                <li>Klare Auswahl</li>
              ...
              <p>Mehr Optionen<br />Individuell w&auml;hlen</p>
              <ul>
              ...
              <p>Direkt Fahrzeug w&auml;hlen<br />Schnell starten</p>
              <ul>
                <li>Schnell verf&uuml;gbar</li>
                <li>Einfach ausw&auml;hlen</li>
