...
orbita24_set_current_page('/optionen/auto/zulassung/');
?>
<!doctype html>
<html lang="de">
  <head>
      ...
      <section class="section structure-section">
        <div class="container structure-container">
          ...
          <div class="structure-header offer-intro">
            <h1>Autozulassung im &Uuml;berblick</h1>
            <p>Fahrzeug schnell und einfach anmelden.</p>
          </div>
          ...
          <div class="offer-grid" aria-label="Demo Angebote">
            <article class="card offer-card">
              ...
              <h2>Basis Option</h2>
              <p>Einfache Anmeldung<br />Schnell starten</p>
              <ul>
              ...
              <p>Individuelle Anmeldung<br />Passend zur Situation</p>
              <ul>
              ...
              <p>Direkt anmelden<br />Online m&ouml;glich</p>
              <ul>
