...
orbita24_set_current_page('/optionen/auto/elektroauto/');
?>
<!doctype html>
<html lang="de">
  <head>
        ...
        <div class="container structure-container">
          ...
          <div class="offer-grid" aria-label="Demo Angebote">
            <article class="card offer-card">
              ...
              <h2>Basis Option</h2>
              <p>Einstieg<br />E-Mobilit&auml;t entdecken</p>
              <ul>
              ...
              <p>Individuelle Auswahl<br />Passend zum Bedarf</p>
              <ul>
              ...
              <p>Direkt starten<br />Einfach verf&uuml;gbar</p>
              <ul>
                <li>Schnell verf&uuml;gbar</li>
                <li>Einfach w&auml;hlen</li>
