...
orbita24_set_current_page('/optionen/immobilien/bewertung/');
?>
<!doctype html>
<html lang="de">
  <head>
      ...
      <section class="section structure-section">
        <div class="container structure-container">
          ...
          <div class="structure-header offer-intro">
            <h1>Immobilienbewertung im &Uuml;berblick</h1>
            <p>Den aktuellen Wert Ihrer Immobilie schnell ermitteln.</p>
          </div>
          ...
          <div class="offer-grid" aria-label="Demo Angebote">
            <article class="card offer-card">
              ...
              <h2>Basis Option</h2>
              <p>Einfache Bewertung<br />Schneller &Uuml;berblick</p>
              <ul>
                <li>Schnelle Einsch&auml;tzung</li>
              ...
              <p>Detaillierte Analyse<br />Genauer Marktwert</p>
              <ul>
                <li>Mehr Details</li>
                <li>Bessere Einsch&auml;tzung</li>
              ...
              <p>Direkte Bewertung online<br />Sofort Ergebnis</p>
              <ul>
                <li>Schnell verf&uuml;gbar</li>
                <li>Online m&ouml;glich</li>
