...
orbita24_set_current_page('/optionen/immobilien/foerderung/');
?>
<!doctype html>
<html lang="de">
  <head>
      ...
      <section class="section structure-section">
        <div class="container structure-container">
          ...
          <div class="structure-header offer-intro">
            <h1>F&ouml;rdermittel im &Uuml;berblick</h1>
            <p>Staatliche Unterst&uuml;tzung f&uuml;r Ihre Immobilie nutzen.</p>
          </div>
          ...
          <div class="offer-grid" aria-label="Demo Angebote">
            <article class="card offer-card">
              ...
              <h2>Basis Option</h2>
              <p>Einfach F&ouml;rderungen pr&uuml;fen<br />Erste &Uuml;bersicht</p>
              <ul>
              ...
              <p>Individuelle F&ouml;rderung<br />Passend zum Projekt</p>
              <ul>
                <li>Mehr M&ouml;glichkeiten</li>
              ...
              <p>Direkt F&ouml;rderung starten<br />Einfach online pr&uuml;fen</p>
              <ul>
                <li>Schnell verf&uuml;gbar</li>
                <li>Direkt nutzbar</li>
                <li>Einfach starten</li>
              </ul>
              <a href="/kontakt.php" class="btn offer-cta" data-offer="true">Zum Angebot</a>
            </article>          </div>
