...
orbita24_set_current_page('/optionen/immobilien/anschlussfinanzierung/');
?>
<!doctype html>
<html lang="de">
  <head>
      ...
      <section class="section structure-section">
        <div class="container structure-container">
          ...
          <div class="structure-header offer-intro">
            <h1>Anschlussfinanzierung im &Uuml;berblick</h1>
            <p>Beste Konditionen f&uuml;r Ihre Anschlussfinanzierung sichern.</p>
          </div>
          ...
          <div class="offer-grid" aria-label="Demo Angebote">
            <article class="card offer-card">
              ...
              <h2>Basis Option</h2>
              <p>Grundlegende Anschlussl&ouml;sung<br />Einfach pr&uuml;fen</p>
              <ul>
                <li>Klare Konditionen</li>
                <li>Einfach verst&auml;ndlich</li>
              ...
              <p>Flexible Anschlussfinanzierung<br />Individuell anpassbar</p>
              <ul>
                <li>Anpassbare Laufzeit</li>
              ...
              <p>Direkt Anschluss sichern<br />Einfach online starten</p>
              <ul>
                <li>Schnell verf&uuml;gbar</li>
                <li>Online abschlie&szlig;bar</li>
                <li>Einfach umgesetzt</li>
              </ul>
              <a href="/kontakt.php" class="btn offer-cta" data-offer="true">Zum Angebot</a>
            </article>          </div>
