...
orbita24_set_current_page('/optionen/immobilien/baufinanzierung/');
?>
<!doctype html>
<html lang="de">
  <head>
      ...
      <section class="section structure-section">
        <div class="container structure-container">
          ...
          <div class="structure-header offer-intro">
            <h1>Baufinanzierung im &Uuml;berblick</h1>
            <p>Passende Finanzierungsl&ouml;sungen f&uuml;r Ihre Immobilie finden.</p>
          </div>
          ...
          <div class="offer-grid" aria-label="Demo Angebote">
            <article class="card offer-card">
              ...
              <h2>Basis Option</h2>
              <p>Einstieg in die Baufinanzierung<br />Einfach und verst&auml;ndlich</p>
              <ul>
