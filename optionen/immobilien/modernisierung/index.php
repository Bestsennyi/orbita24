...
orbita24_set_current_page('/optionen/immobilien/modernisierung/');
?>
<!doctype html>
<html lang="de">
  <head>
      ...
      <section class="section structure-section">
        <div class="container structure-container">
          ...
          <div class="structure-header offer-intro">
            <h1>Modernisierungskredit im &Uuml;berblick</h1>
            <p>Finanzierung f&uuml;r Renovierung und Umbau finden.</p>
          </div>
          ...
          <div class="offer-grid" aria-label="Demo Angebote">
            <article class="card offer-card">
              ...
              <h2>Basis Option</h2>
              <p>Einfache Modernisierung<br />Schnell umsetzbar</p>
              <ul>
              ...
              <p>Individuelle L&ouml;sungen<br />Passend zum Bedarf</p>
              <ul>
              ...
              <p>Direkt Finanzierung starten<br />Online verf&uuml;gbar</p>
              <ul>
