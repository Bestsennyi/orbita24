...
orbita24_set_current_page('/optionen/versicherungen/berufsunfaehigkeitsversicherung/');
?>
<!doctype html>
<html lang="de">
  <head>
      ...
      <section class="section structure-section">
        <div class="container structure-container">
          ...
          <div class="structure-header offer-intro">
            <h1>Berufsunf&auml;higkeitsversicherung einfach erkl&auml;rt</h1>
            <p>Hier finden Sie passende L&ouml;sungen zur Absicherung Ihres Einkommens.</p>
          </div>
          ...
          <div class="offer-grid" aria-label="Empfohlene Optionen">
            <article class="card offer-card">
              ...
              <ul>
                ...
                <li>F&uuml;r viele Berufe geeignet</li>
              </ul>
