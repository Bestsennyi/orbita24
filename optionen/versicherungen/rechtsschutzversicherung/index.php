...
orbita24_set_current_page('/optionen/versicherungen/rechtsschutzversicherung/');
?>
<!doctype html>
<html lang="de">
  <head>
      ...
      <section class="section structure-section">
        <div class="container structure-container">
          ...
          <div class="structure-header offer-intro">
            <h1>Rechtsschutzversicherung einfach erkl&auml;rt</h1>
            <p>Hier finden Sie passende Rechtsschutzversicherungen f&uuml;r Ihren Bedarf.</p>
          </div>
          ...
          <div class="offer-grid" aria-label="Empfohlene Optionen">
            ...
            <article class="card offer-card">
              ...
              <p>Tarife flexibel w&auml;hlen und an Ihre pers&ouml;nliche Lebenssituation anpassen.</p>
              <ul>
            ...
            <article class="card offer-card">
              ...
              <h2>Schnell</h2>
              <p>Schnell abschlie&szlig;en und im Ernstfall rechtlich abgesichert handeln.</p>
              <ul>
