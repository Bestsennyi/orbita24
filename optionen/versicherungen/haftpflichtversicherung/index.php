...
orbita24_set_current_page('/optionen/versicherungen/haftpflichtversicherung/');
?>
<!doctype html>
<html lang="de">
  <head>
      ...
      <section class="section structure-section">
        <div class="container structure-container">
          ...
          <div class="structure-header offer-intro">
            <h1>Haftpflichtversicherung einfach erkl&auml;rt</h1>
            <p>Hier finden Sie passende Haftpflichtversicherungen f&uuml;r Ihren Alltag.</p>
          </div>
          ...
          <div class="offer-grid" aria-label="Empfohlene Optionen">
            ...
            <article class="card offer-card">
              ...
              <p>Flexible Tarife nach Bedarf w&auml;hlen und an Ihre pers&ouml;nliche Situation anpassen.</p>
              <ul>
