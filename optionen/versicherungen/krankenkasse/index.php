...
orbita24_set_current_page('/optionen/versicherungen/krankenkasse/');
?>
<!doctype html>
<html lang="de">
  <head>
      ...
      <section class="section structure-section">
        <div class="container structure-container">
          ...
          <div class="structure-header offer-intro">
            <h1>Krankenkasse einfach erkl&auml;rt</h1>
            <p>Hier finden Sie passende Krankenkassen f&uuml;r Ihre Situation.</p>
          </div>
          ...
          <div class="offer-grid" aria-label="Empfohlene Optionen">
            ...
            <article class="card offer-card">
              ...
              <p>Flexible Tarife je nach Bedarf und Lebenssituation einfach ausw&auml;hlen.</p>
              <ul>
            ...
            <article class="card offer-card">
              ...
              <h2>Schnell</h2>
              <p>Schnell entscheiden und direkt Zugang zu passenden Leistungen erhalten.</p>
              <ul>
