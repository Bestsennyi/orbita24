...
orbita24_set_current_page('/optionen/versicherungen/kfz-versicherung/');
?>
<!doctype html>
<html lang="de">
  <head>
      ...
      <section class="section structure-section">
        <div class="container structure-container">
          ...
          <div class="structure-header offer-intro">
            <h1>KFZ-Versicherung einfach erkl&auml;rt</h1>
            <p>Hier finden Sie passende KFZ-Versicherungen f&uuml;r Ihr Fahrzeug.</p>
          </div>
          ...
          <div class="offer-grid" aria-label="Empfohlene Optionen">
            ...
            <article class="card offer-card">
              ...
              <p>Flexible Tarife passend zu Ihrem Auto und Ihrem pers&ouml;nlichen Fahrverhalten ausw&auml;hlen.</p>
              <ul>
                <li>Passende Selbstbeteiligung</li>
                <li>Schutz nach Bedarf</li>
                <li>Tarif einfach wechseln</li>
              </ul>
              <a href="/kontakt.php" class="btn offer-cta" data-offer="true">Zum Angebot</a>
            </article>
