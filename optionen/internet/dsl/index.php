...
orbita24_set_current_page('/optionen/internet/dsl/');
?>
<!doctype html>
<html lang="de">
  <head>
      ...
      <section class="section structure-section">
        <div class="container structure-container">
          ...
          <div class="structure-header offer-intro">
            <h1>DSL Tarife im &Uuml;berblick</h1>
            <p>Hier finden Sie passende DSL-Angebote f&uuml;r Ihren Anschluss.</p>
          </div>
          ...
          <div class="offer-grid" aria-label="Demo Angebote">
            <article class="card offer-card">
              ...
              <h2>Basis Tarif</h2>
              <p>Zuverl&auml;ssiger DSL-Anschluss<br />Ideal f&uuml;r den Einstieg</p>
              <ul>
              ...
              <h2>Flex Tarif</h2>
              <p>Flexible DSL-L&ouml;sungen<br />F&uuml;r individuelle Nutzung</p>
              <ul>
              ...
              <h2>Direkt Tarif</h2>
              <p>Schneller Einstieg online<br />Direkt verf&uuml;gbar</p>
              <ul>
                <li>Sofort aktivierbar</li>
