...
orbita24_set_current_page('/optionen/internet/mobilfunk/');
?>
<!doctype html>
<html lang="de">
  <head>
    ...
    <main>
      <section class="section structure-section">
        <div class="container structure-container">
            ...
            <a href="/optionen/internet/" class="structure-back" aria-label="Zur&uuml;ck zu Internet">
          ...
          <div class="structure-header offer-intro">
            <h1>Mobilfunktarife im &Uuml;berblick</h1>
            <p>Passende Tarife f&uuml;r Ihren mobilen Alltag finden.</p>
          </div>
          ...
          <div class="offer-grid" aria-label="Demo Angebote">
            <article class="card offer-card">
              ...
              <h2>Basis Tarif</h2>
              <p>Einstieg in Mobilfunk<br />F&uuml;r t&auml;gliche Nutzung</p>
              <ul>
                <li>Telefonie und Internet</li>
                <li>Klare Konditionen</li>
                <li>Einfach nutzbar</li>
              </ul>
              ...
              <h2>Flex Tarif</h2>
              <p>Flexible Nutzung unterwegs<br />Individuell anpassbar</p>
              <ul>
                <li>Flexible Optionen</li>
                <li>Gute &Uuml;bersicht</li>
                <li>Anpassbare Tarife</li>
              </ul>
              <a href="/kontakt.php" class="btn offer-cta" data-offer="true">Zum Angebot</a>
            </article>            <article class="card offer-card">
              <div class="offer-logo" aria-hidden="true">Demo</div>
              ...
              <h2>Direkt Tarif</h2>
              <p>Schnell online starten<br />Direkt verf&uuml;gbar</p>
              <ul>
                <li>Sofort nutzbar</li>
                <li>Online aktivierbar</li>
                <li>Einfach eingerichtet</li>
              </ul>
              <a href="/kontakt.php" class="btn offer-cta" data-offer="true">Zum Angebot</a>
            </article>          </div>
