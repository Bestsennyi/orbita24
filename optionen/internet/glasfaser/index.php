...
orbita24_set_current_page('/optionen/internet/glasfaser/');
?>
<!doctype html>
<html lang="de">
  <head>
      ...
      <section class="section structure-section">
        <div class="container structure-container">
          ...
          <div class="structure-header offer-intro">
            <h1>Glasfaser Internet</h1>
            <p>Moderne Internetl&ouml;sungen mit hoher Geschwindigkeit.</p>
          </div>
          ...
          <div class="offer-grid" aria-label="Demo Angebote">
            <article class="card offer-card">
              ...
              <h2>Basis Tarif</h2>
              <p>Einstieg in Glasfaser<br />Stabil und zuverl&auml;ssig</p>
              <ul>
              ...
              <h2>Flex Tarif</h2>
              <p>Flexible Glasfaser-Angebote<br />F&uuml;r jeden Bedarf geeignet</p>
              <ul>
                <li>Anpassbare Nutzung</li>
              ...
              <h2>Premium Tarif</h2>
              <p>Maximale Geschwindigkeit nutzen<br />F&uuml;r h&ouml;chste Anspr&uuml;che</p>
              <ul>
                <li>Sehr schnelle Verbindung</li>
