...
orbita24_set_current_page('/optionen/internet/streaming/');
?>
<!doctype html>
<html lang="de">
  <head>
      ...
      <section class="section structure-section">
        <div class="container structure-container">
          ...
          <div class="structure-header offer-intro">
            <h1>Streaming Angebote</h1>
            <p>Beliebte Streaming-Dienste im &Uuml;berblick.</p>
          </div>
          ...
          <div class="offer-grid" aria-label="Demo Angebote">
            <article class="card offer-card">
              ...
              <h2>Basis Paket</h2>
              <p>Einstieg<br />F&uuml;r erste Nutzung</p>
              <ul>
              ...
              <h2>Flex Paket</h2>
              <p>Flexible Streaming-Optionen<br />Individuell anpassbar</p>
              <ul>
                <li>Verschiedene Inhalte</li>
                <li>Anpassbare Pakete</li>
              ...
              <h2>Premium Paket</h2>
              <p>Umfangreiche Inhalte<br />Maximaler Zugriff</p>
              <ul>
                <li>Gro&szlig;e Auswahl</li>
                <li>Hohe Qualit&auml;t</li>
                <li>Komfortable Nutzung</li>
              </ul>
              <a href="/kontakt.php" class="btn offer-cta" data-offer="true">Zum Angebot</a>
            </article>          </div>
