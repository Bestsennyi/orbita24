...
orbita24_set_current_page('/optionen/internet/festnetz/');
?>
<!doctype html>
<html lang="de">
  <head>
      ...
      <section class="section structure-section">
        <div class="container structure-container">
          ...
          <div class="structure-header offer-intro">
            <h1>Internet f&uuml;r zuhause</h1>
            <p>Zuverl&auml;ssige Internetl&ouml;sungen f&uuml;r Ihren Haushalt.</p>
          </div>
          ...
          <div class="offer-grid" aria-label="Demo Angebote">
            <article class="card offer-card">
              ...
              <h2>Basis Tarif</h2>
              <p>Stabiler Internetanschluss<br />F&uuml;r zuhause geeignet</p>
              <ul>
                <li>Zuverl&auml;ssige Verbindung</li>
              ...
              <h2>Flex Tarif</h2>
              <p>Flexible Internetl&ouml;sungen<br />F&uuml;r jeden Haushalt</p>
              <ul>
                <li>Anpassbare Optionen</li>
                <li>Gute &Uuml;bersicht</li>
                <li>Moderne Nutzung</li>
              </ul>
              <a href="/kontakt.php" class="btn offer-cta" data-offer="true">Zum Angebot</a>
            </article>            <article class="card offer-card">
              <div class="offer-logo" aria-hidden="true">Demo</div>
              ...
              <h2>Direkt Tarif</h2>
              <p>Schnell eingerichtet<br />Direkt verf&uuml;gbar</p>
              <ul>
                <li>Sofort startklar</li>
                <li>Online buchbar</li>
                <li>Einfach installiert</li>
              </ul>
              <a href="/kontakt.php" class="btn offer-cta" data-offer="true">Zum Angebot</a>
            </article>          </div>
