...
orbita24_set_current_page('/optionen/finanzen/kredit/');
?>
<!doctype html>
<html lang="de">
  <head>
      ...
      <section class="section structure-section">
        <div class="container structure-container">
          ...
          <div class="structure-header offer-intro">
            <h1>Kredit einfach erkl&auml;rt</h1>
            <p>
              Hier finden Sie passende Kreditl&ouml;sungen f&uuml;r Ihre Situation.
            </p>
          </div>
          ...
          <div class="offer-grid" aria-label="Empfohlene Optionen">
            ...
            <article class="card offer-card">
              ...
              <h2>Kredit trotz Schufa</h2>
              <p>
                Kredit trotz Schufa pr&uuml;fen und passende Anbieter finden.
              </p>
              <ul>
