...
orbita24_set_current_page('/optionen/finanzen/kreditkarte/');
?>
<!doctype html>
<html lang="de">
  <head>
      ...
      <section class="section structure-section">
        <div class="container structure-container">
          ...
          <div class="structure-header offer-intro">
            <h1>Kreditkarte einfach erkl&auml;rt</h1>
            <p>Hier finden Sie passende Kartenoptionen f&uuml;r Ihren Alltag.</p>
          </div>
