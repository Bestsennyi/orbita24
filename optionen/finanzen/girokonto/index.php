...
orbita24_set_current_page('/optionen/finanzen/girokonto/');
?>
<!doctype html>
<html lang="de">
  <head>
      ...
      <section class="section structure-section">
        <div class="container structure-container">
          ...
          <div class="structure-header offer-intro">
            <h1>Girokonto einfach erkl&auml;rt</h1>
            <p>Hier finden Sie passende Kontooptionen f&uuml;r Ihren Alltag.</p>
          </div>
          ...
          <div class="offer-grid" aria-label="Empfohlene Optionen">
            <article class="card offer-card">
              ...
              <h2>Girokonto f&uuml;r den Alltag</h2>
              <p>
