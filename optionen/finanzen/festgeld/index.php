...
orbita24_set_current_page('/optionen/finanzen/festgeld/');
?>
<!doctype html>
<html lang="de">
  <head>
      ...
      <section class="section structure-section">
        <div class="container structure-container">
          ...
          <div class="structure-header offer-intro">
            <h1>Festgeld einfach erkl&auml;rt</h1>
            <p>Hier finden Sie passende Festgeldoptionen f&uuml;r planbares Sparen.</p>
          </div>
          ...
          <div class="offer-grid" aria-label="Empfohlene Optionen">
            <article class="card offer-card">
              ...
              <h2>Festgeld f&uuml;r den Alltag</h2>
              <p>
